...
/**
 * @ast node
 * @declaredat /home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/expressions.ast:4
...
public abstract class BinExp extends Exp implements Cloneable {
  ...
  public boolean isUsed(Def d) {
    boolean isUsed_Def_value = getA().isUsed(d) || getB().isUsed(d);
