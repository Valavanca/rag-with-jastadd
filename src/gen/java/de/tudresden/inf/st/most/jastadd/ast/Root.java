...
/**
 * @ast node
 * @declaredat /home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/expressions.ast:1
...
public class Root extends ASTNode<ASTNode> implements Cloneable {
  ...
  /**
   * @aspect <NoAspect>
   * @declaredat /home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/Analysis.jrag:3
   */
   ...
   * @apilevel internal
   */
  public Def Define_lookup(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (getExpNoTransform() != null && _callerNode == getExp()) {
      // @declaredat /home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/NameResolution.jrag:6
      {
          // Root context
   ...
   * @apilevel internal
   */
  public boolean Define_isUsed(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getDefListNoTransform()) {
      // @declaredat /home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/Analysis.jrag:19
      int i = _callerNode.getIndexOfChild(_childNode);
      return getExp().isUsed(getDef(i));
    }
    else {
      return getParent().Define_isUsed(this, _callerNode);
    }
  }
  protected boolean canDefine_isUsed(ASTNode _callerNode, ASTNode _childNode) {
    return true;
  }
  /** @apilevel internal */
  ...
  @ASTNodeAnnotation.Source(aspect="Analysis", declaredAt="/home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/Analysis.jrag:3")
