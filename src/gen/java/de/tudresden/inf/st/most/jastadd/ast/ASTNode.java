...
public class ASTNode<T extends ASTNode> extends beaver.Symbol implements Cloneable {
  /**
   * @aspect Debugging
   * @declaredat /home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/ASTPrinting.jadd:3
   */
  ...
  /**
   * @aspect Debugging
   * @declaredat /home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/ASTPrinting.jadd:41
   */
  ...
  public boolean Define_isUsed(ASTNode _callerNode, ASTNode _childNode) {
    ASTNode self = this;
    ASTNode parent = getParent();
    while (parent != null && !parent.canDefine_isUsed(self, _callerNode)) {
      _callerNode = self;
      self = parent;
      parent = self.getParent();
    }
    return parent.Define_isUsed(self, _callerNode);
  }

  /**
   * @declaredat /home/valavanca/Documents/hal/jastadd-exercise/jastadd_task/src/main/jastadd/Analysis.jrag:19
   * @apilevel internal
   * @return {@code true} if this node has an equation for the inherited attribute isUsed
   */
